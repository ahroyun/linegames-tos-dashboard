...
export const RECENT_CHANGES: RecentChange[] = [
  ...
  },
  {
    ...
    summary: "확률형 아이템 정보 공개 메뉴를 별도 네비게이션 항목으로 분리, 서비스 장애 보상 기준 구체화 (유료 기간제 아이템 장애시간 3배 연장)",
    impact: "high",
    impactLabel: "🔴 높음",
    sourceUrl: "https://pubg.com/ko/clause/term_of_service/label_steam/latest",
    clauses: [
      {
        label: "제15조 [6] (서비스 장애 보상 기준)",
        original: "[6] 회사는 회사가 제공하는 유료서비스 이용과 관련하여 회사의 귀책사유로 사전고지 없이 1일 4시간(누적시간) 이상 연속하여 서비스가 중단되거나 장애가 발생한 경우 유료 기간제 아이템에 한하여 서비스 중단·장애시간의 3배에 해당하는 이용시간을 무료로 연장하고, 이용자는 회사에 대하여 별도의 손해배상을 청구할 수 없습니다. 다만, 회사가 서버점검 등의 사유로 서비스 중단·장애를 사전에 고지하였으나, 서비스 중단·장애시간이 10시간이 초과하는 경우에는 그 초과된 시간만큼 유료 기간제 아이템의 이용시간을 무료로 연장하고, 이용자는 회사에 대하여 별도의 손해배상을 청구할 수 없습니다.",
      },
      {
        label: "네비게이션 — 확률형 아이템 정보 공개 (별도 메뉴 분리)",
        original: "확률형 아이템 정보 공개 (사이트 상단 네비게이션 별도 항목으로 분리 운영)",
        translation: "약관 본문이 아닌 사이트 네비게이션 메뉴에 '확률형 아이템 정보 공개' 항목을 독립적으로 배치하여 이용자 접근성을 강화한 구조.",
      },
    ],
  },
  {
    ...
    summary: "EU 디지털서비스법(DSA) 대응 EEA+UK 보충 조항(Section XIII) 신설 — 불법 콘텐츠 신고 메커니즘, 계정 제재 이의신청 절차, 중재 조항 EEA 예외 명시",
    impact: "medium",
    impactLabel: "🟡 중간",
  ...
  },
  {
    ...
    lang: "EN",
    effectiveDate: "2026-04-15",
    summary: "개인 중재 조항 강화 및 Class Action Waiver 명시, 1년 소멸시효 규정 신설",
    impact: "low",
    impactLabel: "🟢 낮음",
  ...
  },
  {
    ...
    summary: "환불 지연이자 조항 신설 — 전자상거래법 시행령 §21의3 동일 근거 적용",
    impact: "medium",
    impactLabel: "🟡 중간",
    sourceUrl: "https://web-data-cdn.kakaogames.com/real/www/html/terms/index.html?service=S0018&type=T001&lang=ko",
    clauses: [
      {
        label: "제25조 (청약철회 — 환불 지연이자)",
        original: "제1항부터 제4항까지의 규정에 따라 청약 철회가 이루어질 경우 회사는 지체 없이 회원의 유료 콘텐츠를 회수하고 3영업일 이내에 대금을 환급합니다. 이 경우 회사가 환급을 지연한 때에는 그 지연 기간에 대하여 「전자상거래 등에서의 소비자보호에 관한 법률」 및 같은 법 시행령 제21조의3에서 정하는 이율을 곱하여 산정한 지연이자를 지급합니다.",
      },
    ],
  },
];
